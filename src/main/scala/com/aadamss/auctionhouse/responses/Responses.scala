...
object Responses {
  ...
  case class AuctionCreated(auction: AuctionHouse.Auction)
    extends SuccessResponse(Created)

  case class AuctionsFound(auctions: Set[AuctionHouse.Auction])
    extends SuccessResponse(OK)

  case class AuctionFound(auction: AuctionHouse.Auction)
    extends SuccessResponse(OK)

  case class AuctionUpdated(auction: AuctionHouse.Auction)
    extends SuccessResponse(OK)

  case class AuctionJoined(bidder: Auctions.Bidder)
    extends SuccessResponse(Created)
  ...
  case class AuctionNotFound(item: String)
  ...
  case class UnknownError(details: String = "An unknown error occurred!",
